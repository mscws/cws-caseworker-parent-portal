jQuery("#simulation")
  .on("click", ".s-3d3c1068-b03c-4fd4-8e1b-36d0c617325b .click", function(event, data) {
  ...
  .on("windowresize", ".s-3d3c1068-b03c-4fd4-8e1b-36d0c617325b .windowresize", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-3d3c1068-b03c-4fd4-8e1b-36d0c617325b")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/6c866d54-d1ba-4e2e-ad3b-8e020c54851e"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
