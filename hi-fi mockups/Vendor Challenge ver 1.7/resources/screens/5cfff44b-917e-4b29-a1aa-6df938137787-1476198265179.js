jQuery("#simulation")
  .on("click", ".s-5cfff44b-917e-4b29-a1aa-6df938137787 .click", function(event, data) {
  ...
  .on("windowresize", ".s-5cfff44b-917e-4b29-a1aa-6df938137787 .windowresize", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-5cfff44b-917e-4b29-a1aa-6df938137787")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/c27509a6-fa18-4f64-9a74-effcefa0cc2f"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/8fe98d4d-76ac-4044-a314-91cae16b30a8"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
