...
Please refer to the [Installation Guide for Mississippi Vendor Challenge Prototype](https://github.com/mscws/cws-caseworker-parent-portal/blob/master/Assets/Installation%20Guide%20for%20Mississippi%20Vendor%20Challenge%20Prototype.pdf) or the [Prototype Installation Steps](https://github.com/mscws/cws-caseworker-parent-portal/wiki/Protoype-Installation-Steps) for instructions on how to install and run the prototype on another target.
